...
import {Image, ActivityIndicator, StyleSheet, View, Text, TouchableOpacity, Alert} from "react-native";
        ...
        <View style={styles.productSection}>
            ...
            <TouchableOpacity onPress={onPressButton}>
                <View style={product.soldout === 1 ? styles.purchaseDisabled : styles.purchaseButton}>
                    <Text style={styles.purchaseText}>{product.soldout === 1 ? '구매 완료' : '구매하기'}</Text>
                </View>
            </TouchableOpacity>
        </View>
